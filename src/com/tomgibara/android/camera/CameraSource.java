...
public interface CameraSource {
	...
	/**
	 * Attempts to render the current camera view onto the supplied canvas. The
	 * capture will be rendered into the rectangle (0,0,width,height).
	 * Outstanding transformations on the canvas may alter this.
	 * 
	 * @param canvas
	 *            the canvas to which the captured pixel data will be written
